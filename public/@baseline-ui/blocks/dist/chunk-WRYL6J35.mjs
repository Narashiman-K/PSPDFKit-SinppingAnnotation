...
var Block = class _Block {
  ...
  createComponent(key) {
    ...
    return isVoidElement ? /* @__PURE__ */ jsx(Component, { ...props }, keyToUse) : /* @__PURE__ */ jsx(Component, { ...props, children: _children }, keyToUse);
  }
  /**
  ...
  insertBefore(block, ...children) {
    ...
    invariant(id, "The block must have an id.");
  ...
  createDOMNode(container) {
    ...
    ReactDOM.render(element, container || this._container);
